...
# test-build.sh - Local build and test script for iloveimg-python
# Builds the package, runs a local pypiserver, uploads, and tests installation

set -e  # Exit on error

echo "=== iloveimg-python Local Build Test ==="
...
pip install --force-reinstall --no-cache-dir --index-url http://localhost:8080/simple iloveimg

# Verify installation
echo "Verifying package..."
python -c "
from iloveimg import iloveimg
print('✓ Successfully imported iloveimg class')
