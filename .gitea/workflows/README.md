...
- Python files: `*.py`, `iloveimg/**/*.py`, `tests/**/*.py`, `samples/**/*.py`
...
**Requirements:**
- `ILOVEIMG_PUBLIC_KEY` secret
- `ILOVEIMG_SECRET_KEY` secret

**Jobs:**
1. Validate API keys
2. Integration tests (Python 3.10 & 3.14)

**Note:** Tests interact with real iLoveIMG API
...
- `ILOVEIMG_PUBLIC_KEY` - For integration tests
- `ILOVEIMG_SECRET_KEY` - For integration tests

Get keys at: https://developer.iloveimg.com/user/projects
...
- Integration tests against iLoveIMG API
...
| Integration tests fail immediately | Missing secrets | Configure `ILOVEIMG_PUBLIC_KEY` and `ILOVEIMG_SECRET_KEY` |
