...
└── workflows/
    ...
    │   ├── integration-test.yml   # Tests against real iLoveIMG API
...
| Secret | Used by |
|--------|---------|
| `ILOVEIMG_PUBLIC_KEY` | Integration tests |
| `ILOVEIMG_SECRET_KEY` | Integration tests |
...
Get iLoveIMG keys at: https://developer.ilovepdf.com/user/projects
