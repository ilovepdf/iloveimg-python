...
class TestRemoveBackgroundTaskIntegration(BaseTaskIntegrationTest):
    ...
    def test_removebackground_single_file_low(self):
        """
    ...
    def test_removebackground_multiple_files_extreme(self):
        """
        Test the full flow: add multiple files, execute, and download.
        """
