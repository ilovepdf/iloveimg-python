...
to crop a single image file with custom position using the CropTask class."""
...
# Set crop dimensions and starting position in pixels.
my_task.width = 500
my_task.height = 400
my_task.x = 50  # Horizontal offset from the left edge
my_task.y = 50  # Vertical offset from the top edge
